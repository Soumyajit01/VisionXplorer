...
# title = customtkinter.CTkLabel(headingF, font=('Agency FB', rootHeight*0.1,'bold'), text_color='#2d9a9d',text="VisionXplorer",width=round(rootWidth),corner_radius=20)
# title.configure(wraplength=500)
# title.grid(row=0,column=0)
# title.grid_propagate(False)
# print(title.grid_size,title.grid_slaves)
